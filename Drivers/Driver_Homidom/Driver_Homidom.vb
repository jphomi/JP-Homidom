...
<Serializable()> Public Class Driver_Homidom
    Implements HoMIDom.HoMIDom.IDriver

#Region "Variables génériques"
    '!!!Attention les variables ci-dessous doivent avoir une valeur par défaut obligatoirement
    'aller sur l'adresse http://www.somacon.com/p113.php pour avoir un ID
    Dim _ID As String = "097A7386-A17C-11E5-B4E7-082C1D5D46B0" 'ne pas modifier car utilisé dans le code du serveur
    Dim _Nom As String = "Homidom" 'Nom du driver à afficher
    Dim _Enable As Boolean = False 'Activer/Désactiver le driver
    Dim _Description As String = "Driver Homidom" 'Description du driver
    ...
    Dim _urlHomidom As String = "http://localhost:7999/"

    'param avancé
    Dim _DEBUG As Boolean = False
    Dim _IPAdress As String = "localhost"
    Dim _IPPort As String = "7999"
    Dim _IDServeur As String = "123456789"
...
#Region "Fonctions génériques"
    ...
    Public Sub Start() Implements HoMIDom.HoMIDom.IDriver.Start
        Try
            ...
            Try
                ...
                _IDServeur = _Parametres.Item(3).Valeur
            Catch ex As Exception
                _DEBUG = False
            ...
            _urlHomidom = "http://localhost:7999/api/" & _IDServeur & "/device/"
            _urlHomidom = "http://" & _IPAdress & ":" & _IPPort & "/api/" & _IDServeur & "/device/"
            WriteLog("DBG: Start, connection au serveur " & _urlHomidom)
            Dim url As New Uri(_urlHomidom)
    ...
    Public Sub New()
        Try
            ...
            Add_ParamAvance("IPAdress", "Adresse IP", "localhost")
            Add_ParamAvance("IPPort", "Port IP", "7999")
            Add_ParamAvance("IDServeur", "ID Serveur", "123456789")
            Add_ParamAvance("TimeOut", "TimeOut", "30000")
